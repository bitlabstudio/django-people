...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('people_linktypetranslation', 'people_linktypetranslationrenamed')
        db.rename_table('people_nationalitytranslation', 'people_nationalitytranslationrenamed')
        db.rename_table('people_roletranslation', 'people_roletranslationrenamed')
        db.rename_table('people_persontranslation', 'people_persontranslationrenamed')

    def backwards(self, orm):
        db.rename_table('people_linktypetranslationrenamed', 'people_linktypetranslation')
        db.rename_table('people_nationalitytranslationrenamed', 'people_nationalitytranslation')
        db.rename_table('people_roletranslationrenamed', 'people_roletranslation')
        db.rename_table('people_persontranslationrenamed', 'people_persontranslation')
