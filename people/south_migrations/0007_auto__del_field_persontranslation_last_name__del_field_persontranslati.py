...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PersonTranslation.last_name'
        db.delete_column('people_persontranslation', 'last_name')

        # Deleting field 'PersonTranslation.first_name'
        db.delete_column('people_persontranslation', 'first_name')


    def backwards(self, orm):
        # Adding field 'PersonTranslation.last_name'
        db.add_column('people_persontranslation', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'PersonTranslation.first_name'
        raise RuntimeError("Cannot reverse this migration. 'PersonTranslation.first_name' and its values cannot be restored.")
