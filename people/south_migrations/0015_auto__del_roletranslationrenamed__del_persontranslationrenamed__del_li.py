...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'RoleTranslationRenamed'
        db.delete_table('people_roletranslationrenamed')

        # Deleting model 'PersonTranslationRenamed'
        db.delete_table('people_persontranslationrenamed')

        # Deleting model 'LinkTypeTranslationRenamed'
        db.delete_table('people_linktypetranslationrenamed')

        # Deleting model 'NationalityTranslationRenamed'
        db.delete_table('people_nationalitytranslationrenamed')


    def backwards(self, orm):
        # Adding model 'RoleTranslationRenamed'
        db.create_table('people_roletranslationrenamed', (
        ...
        db.send_create_signal('people', ['RoleTranslationRenamed'])

        # Adding model 'PersonTranslationRenamed'
        db.create_table('people_persontranslationrenamed', (
        ...
        db.send_create_signal('people', ['PersonTranslationRenamed'])

        # Adding model 'LinkTypeTranslationRenamed'
        db.create_table('people_linktypetranslationrenamed', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('language', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('link_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.LinkType'])),
        ))
        db.send_create_signal('people', ['LinkTypeTranslationRenamed'])

        # Adding model 'NationalityTranslationRenamed'
        db.create_table('people_nationalitytranslationrenamed', (
            ('nationality', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Nationality'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('language', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('people', ['NationalityTranslationRenamed'])
