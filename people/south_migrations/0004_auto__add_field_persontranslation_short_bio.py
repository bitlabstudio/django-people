...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonTranslation.short_bio'
        db.add_column('people_persontranslation', 'short_bio',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=512, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonTranslation.short_bio'
        db.delete_column('people_persontranslation', 'short_bio')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 2, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
