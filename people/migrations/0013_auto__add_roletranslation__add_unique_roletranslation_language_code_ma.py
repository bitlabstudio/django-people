...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('people_role_translation', (
            ...
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['people.Role'])),
        ))
        db.send_create_signal('people', ['RoleTranslation'])

        # Adding unique constraint on 'RoleTranslation', fields ['language_code', 'master']
        db.create_unique('people_role_translation', ['language_code', 'master_id'])

        # Adding model 'NationalityTranslation'
        db.create_table('people_nationality_translation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('language_code', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['people.Nationality'])),
        ))
        db.send_create_signal('people', ['NationalityTranslation'])

        # Adding unique constraint on 'NationalityTranslation', fields ['language_code', 'master']
        db.create_unique('people_nationality_translation', ['language_code', 'master_id'])

        # Adding model 'LinkTypeTranslation'
        db.create_table('people_linktype_translation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('language_code', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['people.LinkType'])),
        ))
        ...
        db.create_unique('people_linktype_translation', ['language_code', 'master_id'])
        ...
        db.create_table('people_person_translation', (
            ...
            ('language_code', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['people.Person'])),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_unique('people_linktype_translation', ['language_code', 'master_id'])

        # Removing unique constraint on 'NationalityTranslation', fields ['language_code', 'master']
        db.delete_unique('people_nationality_translation', ['language_code', 'master_id'])

        # Removing unique constraint on 'RoleTranslation', fields ['language_code', 'master']
        db.delete_unique('people_role_translation', ['language_code', 'master_id'])

        # Deleting model 'RoleTranslation'
        db.delete_table('people_role_translation')

        # Deleting model 'NationalityTranslation'
        db.delete_table('people_nationality_translation')

        # Deleting model 'LinkTypeTranslation'
        db.delete_table('people_linktype_translation')
