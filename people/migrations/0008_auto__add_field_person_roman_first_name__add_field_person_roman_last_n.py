...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.roman_first_name'
        db.add_column('people_person', 'roman_first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Person.roman_last_name'
        db.add_column('people_person', 'roman_last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Person.non_roman_first_name'
        db.add_column('people_person', 'non_roman_first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Person.non_roman_last_name'
        db.add_column('people_person', 'non_roman_last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.roman_first_name'
        db.delete_column('people_person', 'roman_first_name')

        # Deleting field 'Person.roman_last_name'
        db.delete_column('people_person', 'roman_last_name')

        # Deleting field 'Person.non_roman_first_name'
        db.delete_column('people_person', 'non_roman_first_name')

        # Deleting field 'Person.non_roman_last_name'
        db.delete_column('people_person', 'non_roman_last_name')
